      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-[#D0D0D0] rounded-xl p-5 shadow-sm space-y-4">
          ...
          <button
            onClick={runTests}
            disabled={isRunning}
            className="w-full py-2.5 bg-[#366BB2] text-white font-semibold rounded-lg text-xs flex items-center justify-center gap-2 disabled:opacity-50 transition-all cursor-pointer"
          >
